...
public:
  ...
  ThirdPartyClass(char *value) {
    std::cout << "Char* constructor called with value: " << value << std::endl;
  }

  // should have a ctor with wchar_t* parameter but not
  // ThirdPartyClass(wchar_t *value) {
  //   std::cout << "Wchar_t* constructor called with value: " << value << std::endl;
  // }
};
...
void thirdPartyFunction(char *value) {
  std::cout << "Char* function called with value: " << value << std::endl;
}

// should have a function with wchar_t* parameter but not
// void thirdPartyFunction(wchar_t *value) {
//   std::cout << "Wchar_t* function called with value: " << value << std::endl;
// }
